...
import com.mhd.grit.app.Routes.Companion.toIconRes
import com.mhd.grit.app.Routes.Companion.toStringRes
import com.mhd.grit.core.domain.Pages
import com.mhd.grit.core.habits.presentation.ui.HabitsGraph
import com.mhd.grit.core.presentation.settings.SettingsGraph
import com.mhd.grit.core.tasks.presentation.ui.TasksPage
...
fun Grit() {
    ...
    // تم تعديل targetState ليكون دائماً false لتخطي صفحة الشراء المحذوفة
    AnimatedContent(
        targetState = false,
