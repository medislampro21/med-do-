...
import com.mhd.grit.core.presentation.settings.ui.section.BackupPage
import com.mhd.grit.core.presentation.settings.ui.section.LookAndFeelPage
import com.mhd.grit.core.presentation.settings.ui.section.RootPage
...
//            )
//        }
        // صفحة الاشتراكات الجديدة
       // composable("paywall") {
        //    PaywallPage(
         //       isPlusUser = false,  // 👈 هذا هو السطر الناقص! (نخبره حالياً أنه ليس مشتركاً ليظهر زر الشراء)
